...
const processTheSearch = async ()=>{
    ...
    const searchTerm = _dataFunctionsJs.getSearchTerm();
...
},{}],"jd5GP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getSearchTerm", ()=>getSearchTerm
);
parcelHelpers.export(exports, "retrieveSearchResults", ()=>retrieveSearchResults
);
const getSearchTerm = ()=>{
    const rawSearchTerm = document.querySelector("form > input#ws-search").value.trim();
